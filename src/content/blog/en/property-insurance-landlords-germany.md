...
lang: "en"
tags: ["insurance", "Gebäudeversicherung", "Haftpflicht", "Elementarschaden", "Vermieterrechtsschutz", "Betriebskosten", "Vermieter"]
---
...
| Policy | Status | Typical premium | Allocable to tenant? |
|---|---|---|---|
| **Wohngebäudeversicherung** (building insurance) | Essential | €250-700/yr | Yes |
| **Haus- und Grundbesitzerhaftpflicht** (owner liability) | Essential | €30-100/yr | Yes |
| **Elementarschadenversicherung** (natural hazards) | Strongly recommended | €50-300/yr (rider) | Yes |
| **Mietausfallschutz** (rental loss rider) | Situational | Included in Gebäude | Yes (as part of Gebäude) |
| **Rechtsschutzversicherung** (legal protection) | Situational | €100-300/yr | No |
...
- **Sturm**: storm (from wind force 8, around 62 km/h) and hail
- **Leitungswasser**: damage from broken pipes, including hidden leaks behind walls
- Optional riders: Glas, Elementar, Überspannung (lightning surge), grobe Fahrlässigkeit waiver, Photovoltaik
...
| Small Mehrfamilienhaus | from €43/yr (liability only) to €600+ (full) |
...
- **Verzicht auf Einrede grober Fahrlässigkeit** (waiver of gross negligence defence). Without it, leaving a candle burning or forgetting to drain outdoor pipes voids the claim. Stiftung Warentest's 2026 round rated 68 of 196 tariffs "mangelhaft" largely because they exclude this.
- **At least 12 months Mietausfall** rider. If a fire makes the unit uninhabitable, the rider replaces lost rent during reconstruction.
- **Überspannungsschäden** (lightning surge damage).
- **Mehrkosten by behördliche Auflagen** (extra reconstruction costs to meet current building code).
...
- Loose roof tile falls and hits a parked car
- Tenant or visitor slips on an icy walkway
- Crumbling facade injures a passerby
- Leaking pipe in your unit floods a neighbour's apartment
- Tree on your plot falls onto someone's car
...
- **Überschwemmung** (flooding from rivers, lakes, sea)
- **Starkregen** (heavy rain, the increasingly common one)
- **Rückstau** (sewage backflow)
- **Erdbeben** (earthquake)
- **Erdrutsch**, Erdsenkung, Schneedruck, Lawinen, Vulkanausbruch
...
| ZÜRS zone | Annual rider premium |
|---|---|
...
- **9 April 2025 coalition agreement:** new Wohngebäude policies must be offered with Elementar attached. Existing policies to be extended at a Stichtag with possible opt-out. A state Rückversicherung is planned.
- **26 March 2026 (Bundestag motion 21/5030):** Die Linke demands immediate legislation.
- **Realistic effective date:** 2026 or 2027.
...
- Räumungsklage (eviction proceedings)
- Unpaid rent collection
- Schönheitsreparatur disputes
- Mieterhöhung challenges
- Neighbour disputes
...
- **ARAG**: market leader, comprehensive coverage, no-Wartezeit option
- **Roland**, **ÖRAG**, **Advocard**: solid alternatives
- **Allianz**, **HUK-Coburg**: bundled deals if you have other policies
- **DMB-Rechtsschutz**: this is the Mieterbund's product, primarily for tenants, not landlords
...
- **Wohngebäudeversicherung** including the Mietausfall rider (BGH 2018)
- **Elementarschadenversicherung** as part of Gebäude
- **Glasversicherung** for Gemeinschaftsglas (stairwell windows, etc.)
- **Haus- und Grundbesitzerhaftpflicht**
- **Öltank-Haftpflicht**, **Aufzugs-Haftpflicht**
- PV maintenance/insurance (if leases mention sonstige Betriebskosten)

### NOT allocable

- **Standalone Mietausfallversicherung / Mietnomadenversicherung**
- **Rechtsschutzversicherung**
- Private Haftpflicht des Vermieters
- Personal Hausrat of the landlord
- Self-insurance / Rücklagen contributions
...
- **Already insured up to a stated kWp** in extended Wohngebäude tariffs (check the cap)
- **Above the cap or specialised setups**: add a separate PV-Versicherung
- **Tenant-installed Balkonkraftwerk**: not your problem, it's the tenant's property
...
- **Bundle**: Wohngebäude + Elementar + Glas + PV + Mietausfall rider with one insurer. Simplifies claims, often cheaper overall.
- **Separate**: Haftpflicht and Rechtsschutz often cheaper as standalones.
...
| If you own | You need |
|---|---|
| A house you rent | Wohngebäudeversicherung + Elementar rider + Mietausfall rider + Haus- und Grundbesitzerhaftpflicht + Rechtsschutz |
| A condo in a WEG | Haus- und Grundbesitzerhaftpflicht + Rechtsschutz (Gebäude is in your Hausgeld) |
| A furnished unit | All of the above + Hausrat for your inventory |
| A property with PV | All of the above + PV coverage in extended Wohngebäude or standalone |
...
Calculate the full impact of insurance and other operating costs on your investment with our [rental yield calculator](/rental-yield-calculator), and see how each line item flows into the bigger picture in our [guide to hidden ownership costs](/blog/hidden-costs-rental-property-germany).
