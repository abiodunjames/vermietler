...
lang: "en"
tags: ["KfW", "BEG", "Heizungstausch", "subsidies", "Modernisierungsumlage", "Wärmepumpe"]
---
...
1. **Subtract the KfW subsidy** received (the actual amount, not the eligible base).
2. **Subtract a 15% Erhaltungskostenpauschale** (maintenance flat rate) representing the portion considered routine repair, not improvement.
...
1. **The CO2KostAufG cost share.** Under the new CO2 cost-sharing law, a landlord with an inefficient gas heating system bears 50–95% of CO2 costs (potentially €200–€600/year per unit). A heat pump cuts this share to 0–10%. Over a 15-year horizon, the avoided CO2 costs can fund a significant portion of the upgrade. Use our [rental yield calculator](/rental-yield-calculator) to model this.

2. **AfA depreciation on the unsubsidised portion.** The heating system is added to the building basis and depreciated. Use our [AfA calculator](/afa-calculator) to model the tax effect at your marginal rate.

3. **Property value uplift.** Energy-efficient buildings command higher sale prices and lower vacancy. Properties with poor energy ratings (F/G) increasingly trade at meaningful discounts.

4. **GEG forced replacement timing.** If your boiler fails after the 65% rule applies in your municipality (post-Wärmeplan), you have no choice. Voluntary replacement at a moment of your choosing is cheaper than emergency replacement.

5. **The § 559e rent surcharge.** Even capped at €0.50/m²/month for six years, the surcharge offsets a non-trivial share of the unsubsidised cost.
...
1. KfW funding remains tied to renewable systems. A gas boiler will not be subsidised even after the GEG is replaced.
2. The CO2 cost share continues to penalise inefficient heating regardless of the GEG.
