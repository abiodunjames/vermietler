...
lang: "en"
tags: ["financing", "mortgage", "Eigenkapital", "KfW", "rental investment", "first-time landlord", "Annuitätendarlehen"]
---
...
Use our [mortgage calculator](/hypothekenrechner) to model your exact scenario with different interest rates, repayment rates, and fixed-rate periods.
...
Use our [closing cost calculator](/closing-cost-calculator) to see the exact amount for your state.
...
Model different Tilgung rates and Sondertilgung scenarios with our [mortgage calculator](/hypothekenrechner).
...
**Property:** 65 m² apartment in Leipzig
**Purchase price:** €180,000
**Closing costs:** €18,000 (10% — Saxony at 5.5% GrESt + notary + no agent)
**Eigenkapital:** €40,000
...
Calculate your own scenario: start with our [closing cost calculator](/closing-cost-calculator) for the equity requirement, then use our [mortgage calculator](/hypothekenrechner) for monthly payments, our [rental yield calculator](/rental-yield-calculator) for the return analysis, and our [AfA calculator](/afa-calculator) for the depreciation tax benefit.
