...
lang: "en"
tags: ["Mieterhöhung", "rent increase", "§ 558 BGB", "Kappungsgrenze", "Mietspiegel", "tenant law"]
---

Raising the rent on an existing tenant is one of the most procedurally fragile things a German landlord can do. The substantive rules are not hard, but a single formal mistake and the entire Mieterhöhungsverlangen is void, the rent stays where it was, and you cannot try again for at least a year. This guide walks through the rent increase process under § 558 BGB, the timing constraints, the four valid justifications, and the mistakes that most often defeat a rent increase in court.
...
- **20% over any 3-year period** in standard markets.
- **15% over any 3-year period** in tight markets (angespannte Wohnungsmärkte) designated by Land ordinance.
...
You must:
- Identify the correct Mietspiegel category for the apartment (year built, size, location, fittings).
- State the resulting rent range, e.g., "€8.50 to €11.20 per m²".
- Place the apartment within the range based on Wohnwertmerkmale (positive features push toward the upper bound, negatives toward the lower).
- State the resulting target rent and the math.
...
- **Full consent.** New rent applies as stated.
- **Partial consent** (e.g., agreeing to a smaller increase). Treat as deemed rejection of the original. You can either accept the partial offer or proceed to court for the difference.
- **Silence or refusal.** The Mieterhöhung does not take effect automatically. You must sue for consent (Zustimmungsklage).
...
In practice:
- Most rejected increases are settled before judgment if the legal basis is solid.
- Litigation costs are typically €500 to €1,500 in a typical residential case, recovered from the tenant if you prevail.
- Tenants commonly challenge: the Mietspiegel categorisation, the Wohnwertmerkmale ranking, the comparability of the Vergleichswohnungen, and the formal validity of the request itself.
...
**Step 1: Check timing.**
- Last increase: 1 Feb 2024.
- Earliest send date: 1 Feb 2026 (12 months passed since 1 Feb 2025, the date the prior increase fully took effect, plus the 12-month freeze).
- Earliest effect date: 1 May 2026.

**Step 2: Compute Kappungsgrenze.**
- Cold rent at start of 3-year window (1 May 2023): assume €1,180.
- Maximum increase: 15% × €1,180 = €177.
- Already used: €1,275 minus €1,180 = €95.
- Remaining headroom: €177 minus €95 = €82.
- Maximum new rent under Kappungsgrenze: €1,275 plus €82 = €1,357 (€18.09 per m²).

**Step 3: Check Mietspiegel.**
- Qualified Munich Mietspiegel range for this apartment type and location: €18.50 to €23.40 per m².
- Apartment has good Wohnwertmerkmale (renovated bathroom, balcony, fitted kitchen, EPC class C).
- Reasonable mid-range placement: €19.50 per m². Total target: €1,462.

**Step 4: Apply the lower of the two.**
- Kappungsgrenze allows: €1,357.
- Mietspiegel target: €1,462.
- Use €1,357 (the lower limit). Increase amount: €82.

**Step 5: Draft the letter.**
- Address to both tenants on the lease.
- State new total cold rent of €1,357.
- Reference the Munich Mietspiegel category.
- State the resulting range, list the Wohnwertmerkmale, place the apartment at €19.50 per m².
- Note that the actual increase is constrained by the Kappungsgrenze (no obligation to argue it, but useful for transparency).
- Send by Einschreiben Einwurf.

**Step 6: Wait for the Überlegungsfrist.**
If the tenant receives the letter on 5 February 2026, they have until 30 April 2026 to consent. New rent applies 1 May 2026.
...
- [ ] Last rent change was at least 12 months ago.
- [ ] New rent will not take effect earlier than 15 months after the last change.
- [ ] All tenants on the lease are addressed.
- [ ] The new total cold rent is stated in numbers (not just the increase).
- [ ] At least one of the four valid justifications is included with full reasoning.
- [ ] If using a qualifizierter Mietspiegel, the apartment is categorised within the range and the Wohnwertmerkmale are listed.
- [ ] The new rent is at or below the Kappungsgrenze ceiling for the rolling 3-year window.
- [ ] The new rent is at or below the ortsübliche Vergleichsmiete.
- [ ] No conditions are attached.
- [ ] Sent by Einschreiben Einwurf or another method that proves receipt.
- [ ] The Klagefrist deadline (3 months after Überlegungsfrist ends) is calendared.

---

## How this affects your investment math

Rent increases are not just a tenant relationship issue, they directly compound your long-term yield. A €82 monthly increase like the Munich example above adds €984 per year to gross rental income, which over a typical 15-year holding period is €14,760 of additional revenue, before any subsequent increases. The same property's [rental yield calculation](/rental-yield-calculator) shifts meaningfully when the realised rent tracks the local market rather than lagging it.

For tax purposes, the increased rent flows through to higher Anlage V income and a higher AfA-offset position, with the relative cost depending on your marginal rate. Use the [AfA calculator](/afa-calculator) to model how depreciation absorbs part of the increased rental income at your tax bracket.
