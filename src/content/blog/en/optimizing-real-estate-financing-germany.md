...
lang: "en"
tags: ["financing", "Anschlussfinanzierung", "Forward-Darlehen", "Sondertilgung", "KfW", "rental investment", "tax optimization"]
---
...
| Zinsbindung | Top rate (April 2026) |
|---|---|
| 5 years | ~3.82% |
| 10 years | ~3.69% |
| 15 years | ~3.91% |
...
- Mortgage rate: 3.5%
- After-tax cost of the loan: 3.5% × (1 - 0.42) = **2.03%**
- If you can earn more than 2.03% after tax elsewhere (e.g., a diversified ETF portfolio), holding the debt and investing the cash produces a higher return

**When Sondertilgung still makes sense for investors:**
- Your marginal tax rate is low (the interest deduction is less valuable)
- You're approaching Zinsbindung expiry and want to reduce the refinancing balance
- You want to reduce the LTV to secure better rates at refinancing
- You're risk-averse and prefer guaranteed savings over uncertain investment returns
...
- **Lower Tilgung during vacancy or renovation:** Preserve cash flow when rental income drops temporarily. More of the payment goes to (deductible) interest.
- **Higher Tilgung during full occupancy:** Accelerate repayment when income is strong and you don't need the tax shield.
- **Tax management:** Lowering Tilgung increases the interest portion of each payment, which increases your Werbungskosten deduction for that year.
...
- Loan up to **€150,000 per residential unit** for Effizienzhaus standard with sustainability classification
- Tilgungszuschuss (grant you don't repay): up to **20%** for EH 40 (max €24,000), up to **15%** for EH 55 (max €18,000)
- Tilgungsfreie Anlaufjahre: 1 to 5 years of interest-only payments at the start
- Interest rates significantly below market

### KfW 262: individual measures

- Loan up to **€60,000 per residential unit**
- Covers individual measures: insulation, windows, heating replacement
- Lower grants but simpler process

### Critical rules

- Application must be submitted **before** signing construction contracts. Retrospective applications are rejected.
- An accredited Energieeffizienz-Experte is mandatory for planning and confirmation.
- The KfW loan runs as a separate tranche through your regular bank (Durchleitungsprinzip). It does not replace your existing mortgage.
- Building must be at least 5 years old.
...
**Rules:**
- Disagio up to 5% is presumed market-standard for loans with at least 5-year Zinsbindung
- The loan must be disbursed within 3 months of the Disagio payment (anti-abuse rule per § 42 AO)
- Less common than a decade ago, but still available and useful for investors seeking front-loaded deductions in years with high other income
...
- **After 10 years from full disbursement** (§ 489 BGB): unconditional right to cancel with 6 months' notice, no penalty. This is the single most important exit tool.
- **Variable-rate loans:** cancellable with 3 months' notice, no VFE
- **Bauspardarlehen:** unlimited penalty-free prepayment
...
- **Start refinancing 12 to 18 months before Zinsbindung expiry.** The prolongation offer from your current bank is a starting point, not a final answer. Switching costs are low (~0.1% to 0.2%), savings can be thousands.

- **Forward-Darlehen** locks in rates up to 66 months ahead. Best value at 12 to 24 months forward. The surcharge (0.01% to 0.03%/month) is insurance, not waste.

- **Sondertilgung is not always optimal for rental properties.** At 42% marginal tax rate, your effective loan cost is ~2%. If you can earn more than that after tax, holding the debt is mathematically superior.

- **Negotiate Tilgungssatzwechsel and 10% Sondertilgung** into every contract at signing. The flexibility costs nothing and can save you in tight years.

- **KfW stacking** for energy renovations can save €20,000 to €40,000 per property. Apply before starting work. Time it before your Anschlussfinanzierung for compounding benefits.

- **The 10-year Sonderkündigungsrecht (§ 489 BGB)** is your unconditional exit. After 10 years from disbursement, cancel with 6 months' notice, zero penalty. Recent BGH rulings have also weakened many older VFE clauses.

- **Energy renovation before refinancing** is a double play: KfW grants reduce renovation cost, and a better Energieausweis qualifies you for green financing rates on the main loan.

Model your own scenarios with our [mortgage calculator](/hypothekenrechner), estimate acquisition costs with our [closing cost calculator](/closing-cost-calculator), and see how financing terms affect your bottom line with our [rental yield calculator](/rental-yield-calculator).
