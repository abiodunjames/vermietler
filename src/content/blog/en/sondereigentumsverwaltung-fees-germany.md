...
<span style="font-family:'Space Grotesk',system-ui,sans-serif;font-size:15px;font-weight:700;color:#0f172a">SEV Fee Development 2021–2026</span>
</div>
<p style="font-size:12px;color:#64748b;margin:0 0 20px">Average netto per unit/month (medium-sized properties)</p>
...
<!-- Legend -->
<rect x="170" y="290" width="12" height="12" rx="3" fill="#2563eb"/>
<text x="188" y="300" fill="#334155" style="font-size:12px;font-family:system-ui">With WEG (bundled)</text>
<rect x="340" y="290" width="12" height="12" rx="3" fill="#bfdbfe"/>
<text x="358" y="300" fill="#334155" style="font-size:12px;font-family:system-ui">Without WEG (standalone)</text>
</svg>
</div>
