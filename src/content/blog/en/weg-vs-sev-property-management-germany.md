...
lang: "en"
tags: ["WEG-Verwaltung", "Sondereigentumsverwaltung", "SEV", "property management", "Hausverwaltung", "WEMoG"]
---
...
- Building structure: roof, exterior walls, foundation, load-bearing walls
- Common areas: stairwell, hallways, cellar corridors, laundry rooms, bike storage
- Building systems: central heating, shared water supply, electrical backbone, elevator
- The plot of land (Grundstück)
- Exterior elements: facade, drainage, shared garden, parking areas
...
- Preparing the annual Wirtschaftsplan (budget) and Jahresabrechnung (annual statement)
- Managing the WEG bank account and Hausgeld collection
- Coordinating maintenance and repairs on common property
- Organising and conducting the Eigentümerversammlung (owners' meeting)
- Representing the GdWE (Gemeinschaft der Wohnungseigentümer) externally
- Managing the Instandhaltungsrücklage (maintenance reserve)
...
- Tenant search and selection (Mietersuche, Bonitätsprüfung)
- Drafting and signing the Mietvertrag (rental contract)
- Collecting rent and monitoring payment
- Managing arrears and initiating collection procedures
- Creating the annual Nebenkostenabrechnung for your tenant
- Handling tenant complaints and communication
- Coordinating repairs and maintenance within your unit
- Conducting move-in and move-out inspections (Übergabeprotokoll)
- Managing the Mietkaution (security deposit)
...
| Element | Default classification | Watch out for |
|---|---|---|
| **Windows** | Gemeinschaftseigentum | Many Teilungserklärungen shift maintenance costs to the individual owner, even though ownership stays with the WEG |
| **Balconies** | Mixed: structural elements (slab, railing, waterproofing) are Gemeinschaftseigentum; floor finish and usage space can be Sondereigentum | Repair costs can be split confusingly |
| **Radiators and heating pipes** | Can be assigned to Sondereigentum via Teilungserklärung (BGH 2011) | Check whether your Teilungserklärung has done this |
| **Supply lines** | Gemeinschaftseigentum as long as they serve multiple units; Sondereigentum once they branch off to serve only your unit | The branching point determines who pays for repairs |
| **Rooms housing shared systems** | Per BGH v. 20.2.2026 (V ZR 34/25): can be Sondereigentum even if they contain communal equipment | The room itself may be yours, but the heating system inside it belongs to the WEG |
...
- Overseeing major renovations or Sanierungsmaßnahmen
- Issuing Verwalterzustimmung for apartment sales (§ 12 WEG)
- Handling insurance claims
- Attending court proceedings
- Extraordinary Eigentümerversammlungen
...
- Tenant search and advertising (who pays for Immoscout listings?)
- Bonitätsprüfung and Schufa checks
- Mietvertrag drafting (using whose template?)
- Monthly rent monitoring and arrears management
- Annual Nebenkostenabrechnung
- Coordination of unit-internal repairs
- Übergabeprotokoll at tenant move-in/move-out
- Mietkaution management (separate trust account required)
- Meter readings
- Communication with the WEG-Verwalter for shared-property issues
...
- When you receive monthly financial reports
- How quickly rental income is forwarded to you
- Whether the Verwalter holds funds in a trust account (Fremdgeldkonto) or a pooled account
- What documentation you receive at year-end for your Steuererklärung
...
|---|---|---|
| **Who decides** | Eigentümerversammlung (majority vote) | Individual owner |
| **Typical cost (2026)** | €24–€35/unit/month (netto) | €25–€45/unit/month (brutto) |
| **Legal basis** | WEG (statutory) | § 675 BGB (contractual) |
...
- **Damage attribution:** A water leak between units. Is the cause in the shared piping (WEG pays) or in the unit's internal plumbing (owner pays)? The dual-role Verwalter determines responsibility while representing both parties.
- **Cost shifting:** Pushing maintenance costs to the WEG budget benefits the SEV client but harms other owners who don't have SEV with the same company.
- **Renovation decisions:** The Verwalter recommending a scope of work that serves one owner's rental interests more than the community's structural needs.
...
- You own **3 or more rental units**, especially across different buildings
- The property is **geographically distant** from where you live
- The building is **old and maintenance-intensive**
- You have **difficult tenant situations** (arrears, disputes, frequent turnover)
- You don't have solid knowledge of **German rental law** (BGB §§ 535–580a)
- You can't commit the time for **Nebenkostenabrechnung** (the most time-consuming annual task)

### Self-manage when:

- You own **1 or 2 units** in a building near you
- The building is **newer and well-maintained**
- Your tenant relationship is **stable and unproblematic**
- You understand the basics of Mietrecht and Nebenkostenabrechnung
- You're willing to invest the time (estimate **3–5 hours/month** for one unit including bookkeeping, communication, and annual tasks)

### What self-management actually involves

Don't underestimate the scope:

- **Ongoing:** Rent monitoring, tenant communication, invoice processing, bookkeeping
- **Annual:** Nebenkostenabrechnung (strict formal requirements, 12-month deadline per § 556 BGB), Steuererklärung preparation (Anlage V)
- **Event-driven:** Tenant search, Schufa/Bonitätsprüfung, Mietvertrag drafting, Übergabeprotokoll, repair coordination, arrears management, potential legal disputes
- **Compliance:** Mietpreisbremse rules, Kappungsgrenze for rent increases, Mietkaution in separate trust account, data protection (DSGVO) for tenant data
...
| Ruling | Key takeaway |
|---|---|
| **BGH v. 27.3.2026, V ZR 7/25** | Owners don't need to obtain three comparison offers before approving maintenance work. Resolutions can't be invalidated just because no competitive bids were obtained. |
| **BGH v. 27.2.2026, V ZR 18/25** | The Verwalter is liable for damage to individual units caused by negligent failure to maintain common property. |
| **BGH v. 20.2.2026, V ZR 34/25** | Rooms housing shared systems (like a Heizungsraum) can be Sondereigentum, even though the systems inside them are Gemeinschaftseigentum. |
| **BGH v. 14.11.2025, V ZR 190/24** | Owners cannot withhold Hausgeld, even when they have acknowledged counterclaims. Hausgeld must always be paid; disputes are resolved separately. |
| **BGH v. 26.9.2025, V ZR 206/24** | The outgoing Verwalter (not the successor) must complete the Jahresabrechnung for concluded fiscal years. |
| **BGH v. 5.7.2024, V ZR 34/24** | Individual owners can't sue the Verwalter directly for contract breaches. Claims must go through the GdWE. |

---

## Key takeaways

- **WEG-Verwaltung is statutory**, covers common property, and is decided by the Eigentümerversammlung. **SEV is purely contractual**, covers your unit and your tenant, and is your individual decision.

- **The Teilungserklärung defines the boundary** between Gemeinschaftseigentum and Sondereigentum. Read it before buying. Grey areas (windows, balconies, supply lines) cause disputes.

- **SEV contracts need explicit task lists** because nothing is required by law. If it's not in the contract, the Verwalter won't do it. Watch for hidden Sondervergütung for re-letting and renovations.

- **Since WEMoG 2020**, you can dismiss the WEG-Verwalter by simple majority at any time. The certified Verwalter requirement (§ 26a WEG) is in effect since December 2023.

- **Using the same company for WEG and SEV** is cheaper but creates conflicts of interest. If cost allows, separate providers are safer.

- **Self-management saves €300–€540/year per unit** but requires time, legal knowledge, and strict compliance with Nebenkostenabrechnung rules. Tools like [Vermietler](/) can bridge the gap.

Calculate your ownership costs including management fees with our [rental yield calculator](/rental-yield-calculator), and read our [guide to hidden ownership costs](/blog/hidden-costs-rental-property-germany) for the full picture of what eats into your return.
